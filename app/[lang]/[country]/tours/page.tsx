...
export async function generateMetadata(
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://asiabuddy.app/${lang}/${countrySlug}/tours`,
      images: [
        {
...
export default async function ToursPage({
  ...
  // normalizeLocale already returns uppercase, matching UI_TEXT keys
  const targetLanguageUpper = targetLanguage
  ...
  const uiLabels = UI_TEXT[targetLanguageUpper] || UI_TEXT.EN
  ...
  const translatedTours = activeTours.map((tour) => {
    const lang = targetLanguageUpper.toLowerCase()
    
    // For English, use original columns directly
    if (targetLanguageUpper === 'EN') {
      return {
        ...tour,
        title: tour.title || '',
