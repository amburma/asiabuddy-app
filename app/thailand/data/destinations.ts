    ...
    pillars: {
      mustVisit: [
        ...
        },
        {
          ...
          badge: 'Heritage',
          description: 'Colorful Sino-Portuguese shophouses and historic heritage.',
        ...
        hiddenGems: [
          {
            ...
            etiquette: 'ငြိမ်သက်စွာ လေ့လာရန် မေต္တာရပ်ခံသည်။',
            imageLabel: 'wat_sam_phran'
          },
          {
        ...
        uniqueActivities: [
          {
            ...
            badge: 'ဟင်းချက်သင်တန်း',
            description: 'ရိုးရာထိုင်းဟင်းလျาများ ချက်ပြုတ်ပုံကို လက်တွေ့လေ့ကျင့်ပါ။',
            imageLabel: 'phuket_cooking_class'
          }
        ],
        hiddenGems: [
        ...
        uniqueActivities: [
          {
            ...
            badge: 'ဟင်းချက်သင်တန်း',
            description: 'လှပသော ကျွန်းသစ်အိမ်ကြီးတွင် လန်နာဟင်းလျาများကို လေ့လာပါ။',
            imageLabel: 'pantawan_cooking'
          }
        ],
        hiddenGems: [
        ...
        hiddenGems: [
          {
            ...
            badge: 'လူသိနည်းသောနေရာများ',
            description: 'မြစ်ကမ်းဘေးလူနေမှုပုံစံနှင့် ดေသထွက်ပစ္စည်းများ။',
            imageLabel: 'pattaya_floating_market'
          }
        ]
      }
        ...
        dining: [
          {
            title: 'ခရာဘီ ညစျေး',
            badge: 'လမ်းဘေးအစားအစာ',
            description: 'တောင်ပိုင်းထိုင်းအရသာနှင့် ลတ်ဆတ်သော ပင်လယ်စာများ။',
            imageLabel: 'krabi_night_market'
          }
        ],
        otherExperiences: [
...
spanish: [
  ...
  },
  {
    ...
    name: 'Ayutthaya',
    thaiName: 'พระนครศรีอยุธยา',
    overview: 'La antigua capital del Reino de Siam, ahora un sitio del Patrimonio Mundial de la UNESCO lleno de ruinas en expansión.',
    bestTime: 'Noviembre a Febrero',
    pillars: {
      mustVisit: [
        {
      ...
      otherExperiences: [
        {
          ...
          badge: 'Heritage',
          description: 'Explore las ruinas de la antigua capital siamesa.',
          imageLabel: 'ayutthaya_park'
        }
      ],
      uniqueActivities: [
    ...
    pillars: {
      ...
      dining: [
        ...
        },
        {
          ...
          badge: 'Local Market',
          description: 'Marché de produits frescos haut de gamme connu pour ses produits agricoles de la plus haute qualité.',
          imageLabel: 'or_tor_kor'
        }
      ],
      otherExperiences: [
  ...
  },
  {
    ...
    pillars: {
      ...
      otherExperiences: [
        {
          title: 'Parque historique d\'Ayutthaya',
          badge: 'Patrimoine',
  ...
  },
  {
    ...
    name: 'Phuket',
    thaiName: 'ภูเก็ต',
    overview: 'La Perla delle Andamane, sinonimo di sabbie bianche, acque cristalline e fascino storico della Città Vecchia.',
    bestTime: 'Novembre ad Aprile',
    pillars: {
      mustVisit: [
        {
          title: 'Grande Buddha',
          badge: 'Landmarks',
          description: 'Una statua di marmo bianco alta 45 metri che offre viste panoramiche.',
          etiquette: 'Richiesto abbigliamento modesto.',
          imageLabel: 'big_buddha_phuket'
        },
        {
          title: 'Città Vecchia di Phuket',
          badge: 'Heritage',
          description: 'Colorate case a schiera sino-portoghesi e patrimonio storico.',
          imageLabel: 'phuket_old_town'
        }
      ],
      dining: [
        {
          title: 'Mercato domenicale della strada pedonale',
          badge: 'Street Food',
          description: 'Il mercato gastronomico e artigianale più vivace di Phuket Town.',
          imageLabel: 'phuket_sunday_market'
        },
        {
          title: 'Blue Elephant Phuket',
          badge: 'Authentic',
          description: 'Cucina raffinata in uno storico palazzo del governatore.',
          imageLabel: 'blue_elephant_phuket'
        }
      ],
      otherExperiences: [
        {
          title: 'Bangla Road',
          badge: 'Nightlife',
          description: 'Il centro della vita notturna di Phuket con club e bar.',
          imageLabel: 'bangla_road'
        }
      ],
      uniqueActivities: [
        {
          title: 'Thai Cooking Academy',
          badge: 'Cooking Class',
          description: 'Formazione pratica sui piatti tradizionali tailandesi.',
          imageLabel: 'phuket_cooking_class'
        }
      ],
      hiddenGems: [
        {
          title: 'Banana Beach',
          badge: 'Hidden Gem',
          description: 'Una spiaggia appartata con acqua cristallina e meno turisti.',
          imageLabel: 'banana_beach'
        }
      ]
    }
  },
  {
    ...
    name: 'Chiang Mai',
    thaiName: 'เชียงใหม่',
    overview: 'La Rosa del Nord, un santuario della cultura Lanna, montagne nebbiose e templi secolari.',
    bestTime: 'Novembre a Febbraio',
    pillars: {
      mustVisit: [
        {
          title: 'Wat Phra That Doi Suthep',
          badge: 'Landmarks',
          description: 'Una pagoda dorata arroccata su una montagna con vista sulla città.',
          etiquette: 'Richiesto abbigliamento modesto.',
          imageLabel: 'doi_suthep'
        },
        {
          title: 'Porta Tha Phae',
          badge: 'Public Square',
          description: 'L\'ingresso storico della città vecchia e un centro sociale.',
          imageLabel: 'tha_phae_gate'
        }
      ],
      dining: [
        {
          title: 'Khao Soi Mae Sai',
          badge: 'Street Food',
          description: 'Tradizionali spaghetti al curry della Tailandia settentrionale.',
          imageLabel: 'khao_soi_mae_sai'
        }
      ],
      otherExperiences: [
        {
          title: 'Strada pedonale Wua Lai',
          badge: 'Local Crafts',
          description: 'Famoso mercato del sabato noto per l\'argenteria e l\'artigianato.',
          imageLabel: 'silver_street'
        }
      ],
      uniqueActivities: [
        {
          title: 'Scuola di cucina Pantawan',
          badge: 'Cooking Class',
          description: 'Impara la cucina Lanna in una splendida casa in teak.',
          imageLabel: 'pantawan_cooking'
        }
      ],
      hiddenGems: [
        {
          title: 'Wat Pha Lat',
          badge: 'Hidden Gem',
          description: 'Un tranquillo tempio nella giungla nascosto sulla montagna.',
          imageLabel: 'wat_pha_lat'
        }
      ]
    }
  },
  {
    ...
    name: 'Pattaya',
    thaiName: 'พัทยา',
    overview: 'Una vivace città costiera nota per i suoi diversi intrattenimenti, attrazioni per famiglie e fughe sulle isole.',
    bestTime: 'Novembre a Marzo',
    pillars: {
      mustVisit: [
        {
          title: 'Santuario della Verità',
          badge: 'Landmarks',
          description: 'Un massiccio padiglione in legno pieno di intricati intagli.',
          imageLabel: 'sanctuary_of_truth'
        }
      ],
      dining: [
        {
          title: 'The Sky Gallery',
          badge: 'Cafe Culture',
          description: 'Cena in cima a una scogliera con vista mozzafiato sul Golfo di Tailandia.',
          imageLabel: 'sky_gallery_pattaya'
        }
      ],
      otherExperiences: [
        {
          title: 'Walking Street',
          badge: 'Nightlife',
          description: 'Famoso quartiere dei divertimenti dopo il tramonto.',
          imageLabel: 'pattaya_walking_street'
        }
      ],
      uniqueActivities: [
        {
          title: 'Gita di un giorno a Koh Larn',
          badge: 'Nature',
          description: 'Esplora acque limpide e spiagge in un\'isola vicina.',
          imageLabel: 'koh_larn'
        }
      ],
      hiddenGems: [
        {
          title: 'Mercato galleggiante di Pattaya',
          badge: 'Hidden Gem',
          description: 'Autentica vita lungo il fiume e artigianato locale.',
          imageLabel: 'pattaya_floating_market'
        }
      ]
    }
  },
  {
    ...
    name: 'Krabi',
    thaiName: 'กระบี่',
    overview: 'Una provincia di meravigliose scogliere calcaree, lagune color smeraldo e arrampicate di livello mondiale.',
    bestTime: 'Novembre ad Aprile',
    pillars: {
      mustVisit: [
        {
          title: 'Tempio della grotta della tigre',
          badge: 'Landmarks',
          description: 'Un sito spirituale che richiede una salita di 1.237 gradini per una vista meravigliosa.',
          imageLabel: 'tiger_cave_krabi'
        }
      ],
      dining: [
        {
          title: 'Mercato notturno di Krabi',
          badge: 'Street Food',
          description: 'Sapori locali della Tailandia meridionale e mercato di pesce fresco.',
          imageLabel: 'krabi_night_market'
        }
      ],
      otherExperiences: [
        {
          ...
          badge: 'Nature',
          description: 'Raggiungibile solo in barca, famosa per l\'arrampicata.',
          imageLabel: 'railay_beach'
        }
      ],
      uniqueActivities: [
        {
          title: 'Tour delle quattro isole',
          badge: 'Nature',
          description: 'Tour tradizionale su barche longtail delle isole.',
          imageLabel: 'four_islands'
        }
      ],
      hiddenGems: [
        {
          title: 'Piscina di Smeraldo',
          badge: 'Hidden Gem',
          description: 'Una sorgente termale naturale con acqua turquesa nella foresta.',
          imageLabel: 'emerald_pool'
        }
      ]
    }
  },
  {
    ...
    name: 'Ayutthaya',
    thaiName: 'พระนครศรีอยุธยา',
    overview: 'L\'antica capitale del Regno del Siam, ora patrimonio mondiale dell\'UNESCO piena di rovine tentacolari.',
    bestTime: 'Novembre a Febbraio',
    pillars: {
      mustVisit: [
        {
          title: 'Wat Mahathat',
          badge: 'Landmarks',
          description: 'Famoso per la testa di Buddha in pietra intrecciata tra le radici degli alberi.',
          imageLabel: 'wat_mahathat'
        }
      ],
      dining: [
        {
          title: 'Mercato notturno di Ayutthaya',
          badge: 'Local Market',
          description: 'Deliziosi snack tradizionali e gamberi di fiume giganti.',
          imageLabel: 'ayutthaya_market'
        }
      ],
      otherExperiences: [
        {
          title: 'Parco storico di Ayutthaya',
          badge: 'Heritage',
          description: 'Esplora le rovine dell\'antica capitale siamese.',
          imageLabel: 'ayutthaya_park'
        }
      ],
      uniqueActivities: [
        {
          title: 'Tour Elephant World',
          badge: 'Culture',
          description: 'Interazione ecologica e rovine storiche.',
          imageLabel: 'ayutthaya_elephant'
        }
      ],
      hiddenGems: [
        {
          title: 'Wat Chaiwatthanaram',
          badge: 'Hidden Gem',
          description: 'Uno dei templi meglio conservati e più belli di Ayutthaya.',
          imageLabel: 'wat_chaiwatthanaram'
        }
      ]
    }
