            ...
            >
              ...
              <div className="flex-grow overflow-y-auto p-8 scroll-smooth bg-white scrollbar-thin scrollbar-thumb-gold-soft scrollbar-track-transparent">
                <div className="markdown-body mb-20">
                  ...
                  >
                    {TRAVEL_STYLE_GUIDE[language] || TRAVEL_STYLE_GUIDE.english}
                  </ReactMarkdown>
                </div>
              ...
              <div className="p-6 bg-sacred-bg border-b border-gray-100 flex items-center justify-between sticky top-0 z-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 font-medium uppercase tracking-tighter text-gold-deep">
                      Healthcare, Checkups & Preparation
                    </p>
                  </div>
                </div>
                <button 
              ...
              <div className="flex-grow overflow-y-auto p-8 scroll-smooth bg-white scrollbar-thin scrollbar-thumb-gold-soft scrollbar-track-transparent">
                <div className="markdown-body mb-20">
                  <ReactMarkdown 
                    ...
                    components={MarkdownComponents}
                  >
                    {MEDICAL_GUIDE_MARKDOWN[language] || MEDICAL_GUIDE_MARKDOWN.english}
                  </ReactMarkdown>
                </div>
              ...
              <div className="flex-grow overflow-y-auto p-8 scroll-smooth bg-white scrollbar-thin scrollbar-thumb-gold-soft scrollbar-track-transparent">
                <div className="markdown-body mb-20">
                  <ReactMarkdown 
                    ...
                    components={MarkdownComponents}
                  >
                    {NIGHTLIFE_GUIDE_MARKDOWN[language] || NIGHTLIFE_GUIDE_MARKDOWN.english}
                  </ReactMarkdown>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 font-medium tracking-tight">
                      {uiT.shopping?.detailsTitle || 'Shopping Guide'}
                    </p>
                  </div>
                </div>
                <button 
              ...
              <div className="flex-grow overflow-y-auto p-8 scroll-smooth no-scrollbar bg-white max-w-none">
                <div className="markdown-body">
                  <ReactMarkdown 
                    ...
                    components={MarkdownComponents}
                  >
                    {SHOPPING_GUIDE_MARKDOWN[language] || SHOPPING_GUIDE_MARKDOWN.english}
                  </ReactMarkdown>
                </div>
              ...
              <div className="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-sacred-bg/50">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 font-medium lowercase italic">Practical guidance for your stay</p>
                  </div>
                </div>
                <button 
                  onClick={() => setShowInfoModal(false)}
              ...
              <div className="flex-1 overflow-y-auto p-8 scrollbar-thin scrollbar-thumb-gold-soft scrollbar-track-transparent bg-white">
                <div className="markdown-body">
                  <ReactMarkdown 
                    ...
                    components={MarkdownComponents}
                  >
                    {GENERAL_INFORMATION[language] || GENERAL_INFORMATION.english}
                  </ReactMarkdown>
                </div>
              </div>
              ...
              <div className="flex-grow overflow-y-auto p-8 scroll-smooth bg-white scrollbar-thin scrollbar-thumb-gold-soft scrollbar-track-transparent">
                <div className="markdown-body">
                  <ReactMarkdown 
                    ...
                    components={MarkdownComponents}
                  >
                    {VAT_REFUND_GUIDE[language] || VAT_REFUND_GUIDE.english}
                  </ReactMarkdown>
                </div>
              </div>
              ...
              <div className="flex-grow overflow-y-auto p-8 scroll-smooth bg-white scrollbar-thin scrollbar-thumb-gold-soft scrollbar-track-transparent">
                <div className="markdown-body">
                  <ReactMarkdown 
                    ...
                    components={MarkdownComponents}
                  >
                    {VISA_GUIDE[language] || VISA_GUIDE.english}
                  </ReactMarkdown>
                </div>
              </div>
            ...
            >
              ...
              <div className="flex-grow overflow-y-auto p-8 scroll-smooth no-scrollbar bg-white max-w-none">
                <div className="markdown-body">
                  ...
                  >
                    {(() => {
                      const transportData = TRANSPORT_DETAILS[language] || TRANSPORT_DETAILS.english;
              ...
              <div className="flex-grow overflow-y-auto p-8 scroll-smooth no-scrollbar bg-white max-w-none">
                <div className="markdown-body">
                  <ReactMarkdown 
                    ...
                    components={MarkdownComponents}
                  >
                    {ACCOMMODATION_GUIDE[language] || ACCOMMODATION_GUIDE.english}
                  </ReactMarkdown>
                </div>
              ...
              <div className="flex-grow overflow-y-auto p-8 scroll-smooth no-scrollbar bg-white max-w-none">
                <div className="markdown-body">
                  <ReactMarkdown 
                    ...
                    components={MarkdownComponents}
                  >
                    {FOOD_GUIDE_MARKDOWN[language] || FOOD_GUIDE_MARKDOWN.english}
                  </ReactMarkdown>
                </div>
              ...
              <div className="flex-grow overflow-y-auto p-8 scroll-smooth no-scrollbar bg-white max-w-none">
                <div className="markdown-body">
                  <ReactMarkdown 
                    ...
                    components={MarkdownComponents}
                  >
                    {(TRANSPORT_DETAILS[language] || TRANSPORT_DETAILS.english).appsGuideMarkdown || (TRANSPORT_DETAILS.english.appsGuideMarkdown || '')}
                  </ReactMarkdown>
                </div>
              </div>
