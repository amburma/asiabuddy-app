...
const ENGLISH_UI = {
  ...
  "lawsRegulationsLink": "Crucial Regulations for 2026",
  "transport": {
    "title": "Transport",
  ...
  "lawsModalSubtitle": "Crucial Regulations for 2026",
  ...
  "chat": {
    "welcome": "Sawasdee khrap. I'm ThaiGuide from AsiaBuddy.app. How may I assist you today?",
    "placeholder": "Ask anything...",
    "title": "Thai Concierge",
    "status": "Service Mind • Professional Guidance",
    "hint": "Ask about temples, food or transport",
...
export const UI_TRANSLATIONS: Record<SupportedLanguage, typeof ENGLISH_UI> = {
  ...
  "legalAdvisory": "Legal Advisory",
  "legalDesc": "Thailand has specific laws regarding the monarchy, drugs, and public behavior.",
  "lawsModalSubtitle": "ระเบียบข้อบังคับที่สำคัญสำหรับปี 2026",
  "lawsModalTitle": "Key Laws in Thailand",
  "lawsModalIntro": "Stay safe and respectful by knowing these laws.",
  "lawsProTipTitle": "Pro Tip",
  "lawsDisclaimer": "This is a general guide, not legal advice.",
  ...
  "accommodation": {
    ...
    "chatTitle": "Accommodation Help",
    "detailsTitle": "Accommodation Details",
    "guideLink": "တည်းခိုနေထိုင်မှု လမ်းညွှန် လင့်ခ်",
    "suggestions": [
      "Luxury Hotels",
      "Boutique Hostels",
      "Beach Resorts"
  ...
  "tools": {
    ...
    "phrasesChat": {
      "placeholder": "Pregunte cualquier frase esencial que desee saber...",
      "suggestions": [
        "¿Cuánto cuesta?",
        "Gracias",
        "¿Baño?",
  ...
  "etiquetteSections": [
    {
      ...
      "points": [
        "Quién empieza: Los jóvenes deben iniciar el Wai hacia los mayores."
      ]
    }
  ],
  "quickTips": {
  ...
  "jaiYen": "\"Jai Yen\" — Corazón Frío",
  "jaiYenDesc": "Entender la etiqueta tailandesa se trata de mostrar respeto y mantener la armonía social.",
  "legalAdvisory": "Aviso Legal",
  "legalDesc": "Tailandia tiene leyes específicas sobre la monarquía, las drogas y el comportamiento público.",
  "lawsModalSubtitle": "Regulaciones cruciales para 2026",
  ...
  "chat": {
    "welcome": "Sawasdee khrap. Soy ThaiGuide de AsiaBuddy.app. ¿Cómo puedo asistirle hoy?",
    "placeholder": "Pregunte cualquier cosa...",
    "title": "Conserje Tailandés",
    "status": "Mente de Servicio • Guía Profesional",
    "hint": "Pregunte sobre templos, comida o transporte",
  ...
  "jaiYen": "\"Jai Yen\" — Le Cœur Frais",
  "jaiYenDesc": "Comprendre l'étiquette thaïlandaise consiste à montrer du respect et à maintenir l'harmonie sociale.",
  "legalAdvisory": "Conseil Juridique",
  "legalDesc": "La Thaïlande a des lois spécifiques concernant la monarchie, des drogues et le comportement public.",
  "lawsModalSubtitle": "Réglementations cruciales pour 2026",
  ...
  "chat": {
    ...
    "hint": "Interrogez sur les temples, la nourriture ou le transport",
    "advice": "Conseil Professionnel",
    "digitalHelp": "Aide Numérique",
    "suggestionsLabel": "Demandes Courantes",
    "statusActive": "Concierge Actif",
    "processing": "Réflexion...",
    "safe": "Bon voyage !"
  },
  "footer": {
    "by": "Services AsiaBuddy",
  ...
  "lawsModalSubtitle": "Wichtige Vorschriften für 2026",
  ...
  "chat": {
    ...
    "hint": "Fragen Sie nach Tempeln, Essen oder Transport",
