        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="bg-white border border-gray-100 p-4 rounded-2xl rounded-tl-none shadow-sm flex items-center gap-2">
              ...
              <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest leading-none">{chatT.processing || 'ThaiGuide is thinking...'}</span>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="p-4 bg-white border-t border-gray-100">
        ...
        >
          ...
          <div className="text-left">
            <p className="text-xs font-bold uppercase tracking-wider">{chatT.bookNow}</p>
            <p className="text-[9px] opacity-90">{chatT.bookNowSubtitle}</p>
          </div>
        </motion.button>
      </div>
